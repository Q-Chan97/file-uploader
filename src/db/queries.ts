...
export const createDefaultFolder = async (userId: number) => {
...
export const createNewFolder = async (userId: number, folderName: string) => {
    return await prisma.folder.create({
        data: {
            userId: userId,
            name: folderName,
...
function checkFileExt(file: Express.Multer.File) {
...
export const createNewFile = async (newFile: Express.Multer.File, userId: number, folderString?: string) => {
    ...
    if (goodFile) {
        ...
        return await prisma.file.create({
            data: {
                ...
                userId: userId,
                folderId: folderString ? parseInt(folderString) : null,
            }
        })
    } else {
...
export const getAllUserFiles = async (userId: number) => {
...
export const deleteSingleFile = async (fileId: number) => {
